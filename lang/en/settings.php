<?php
$lang['apr_namespaces'] = 'Namespaces this plugin apply to (space separated list). Left blank for all pages.';
...
$lang['default_maintainer'] = 'Default maintainer for notification plugin.';
